...
MACRO_CONFIG_INT(SvScorelimit, sv_scorelimit, 1000, 0, 0, CFGFLAG_SERVER, "Score limit (0 disables)")
MACRO_CONFIG_INT(SvTimelimit, sv_timelimit, 0, 0, 1000, CFGFLAG_SERVER, "Time limit in minutes (0 disables)")
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "SpeedFNG", CFGFLAG_SERVER, "Game type (dm, tdm, ctf)")
...
MACRO_CONFIG_INT(SvEndvoteScore, sv_endvote_score, 10, 0, 100, CFGFLAG_SERVER, "cause vote on extending the map as soon as there is this much score left to hit the scorelimit")
...
MACRO_CONFIG_INT(SvMeltSafeticks, sv_melt_safeticks, 20, 0, 300, CFGFLAG_SERVER, "how many ticks to be unfreezable after melting (not when being molten per hammer)")
...
MACRO_CONFIG_INT(SvHammerFreeze, sv_hammer_freeze, 3, 0, 10, CFGFLAG_SERVER, "number of seconds to freeze when hit with a hammer")
...
MACRO_CONFIG_INT(SvKillingspreeKills, sv_kspree_kills, 3, 1, 5, CFGFLAG_SERVER, "How many kills are needed to be on a killing-spree")
MACRO_CONFIG_INT(SvKillingspreeAward, sv_kspree_award, 1, 0, 1, CFGFLAG_SERVER, "If players with more than \"sv_killingspree_kills\" kills get the killingspree award")
...
MACRO_CONFIG_INT(SvGrenadeAmmo, sv_grenade_ammo, 5, 5, 10, CFGFLAG_SERVER, "Your grenade ammo will regenerate after some while")
MACRO_CONFIG_INT(SvPrintKillingSpree, sv_print_killingspree, 1, 0, 1, CFGFLAG_SERVER, "0 disables, 1 enables display killingspree msg")
MACRO_CONFIG_INT(SvDisplayBroadcast, sv_display_broadcast, 0, 0, 1, CFGFLAG_SERVER, "0 disables, 1 enables display broadcast")
MACRO_CONFIG_INT(InsultProtection, insult_protection, 1, 0, 2, CFGFLAG_SERVER, "Kick automaticly players if they are insulting")
MACRO_CONFIG_INT(SvAntiBot, sv_anti_bot, 1, 0, 1, CFGFLAG_SERVER, "Enable BoteDetection")
MACRO_CONFIG_INT(SvChatDelay, sv_chat_delay, 1, 0, 9999, CFGFLAG_SERVER, "The time in seconds between chat messages")
MACRO_CONFIG_INT(SvShowChatkills, sv_show_chatkills, 1, 0, 1, CFGFLAG_SERVER, "Show Chatkills in Chat")
